...
from constants import TEST_RANDOMIZE_SHIP_START, TEST_RANDOMIZE_SHIP_COMPLETE, \
    ...
    TEST_RANDOMIZE_TMP_DB_START, TEST_RANDOMIZE_TMP_DB_COMPLETED
...
from tests.services import ComponentMapper, ship_service, \
    component_service
...
class RandomizeDatabase():
    ...
    def _randomize_ship(self, ship_id: str) -> None:
        ...
        ship_service.update_ship_component(self.db, ship_id, component,
                                           new_component_id)
    ...
    def _randomize_component(self, component_id: str,
                             comp_structure: ComponentStructure) -> None:
